...
x_train_smote, x_test_smote, y_train_smote, y_test_smote = train_test_split(x_train_smote,y_train_smote, test_size = 0.3, random_state = 35)
...
st.subheader('Accuracy without smote: ')
